...
sigmax= 0.01    # Least Counts
sigmay =  1     # Least Counts


x = data['current(A)']  
y = data['magnetic field(G)']
...
def create_graph(file_name):
    ...
    xlabel_ = r"Current(A)"
    ylabel_ = r"Magnetic field(G)"
    title_ = r"Callibration curve"
    ...
    plt.savefig(f"/home/nrpal/mycode/codes/all_code/6th sem/SSP/Hall effect/Output_img/CallibrationA.png", bbox_inches='tight', pad_inches=0.1)  # This will save the image in the current working directory
    plt.close()
